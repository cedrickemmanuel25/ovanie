...
@if($isEligible)
    ...
    <span class="ovanie-pod-badge-wrap">
        ...
        <span class="ovanie-pod-tooltip" role="tooltip">
            <strong>Disponible uniquement pour les produits éligibles et dans certaines zones géographiques.</strong>
            <h4>🚚 Paiement à la livraison</h4>
            <p>Le paiement à la livraison est disponible uniquement pour les produits éligibles et dans les zones couvertes par nos partenaires de livraison. Le client doit régler l'intégralité du montant de sa commande au moment de la réception. Tout refus injustifié d'une commande après son expédition peut entraîner la suspension temporaire ou définitive de l'accès à ce mode de paiement.</p>
