        ...
        <section class="ov-panel ov-promo-panel">
            <div class="ov-section-head">
                <div class="ov-section-head__title">
                    <span class="ov-kicker">OFFRES EN COURS</span>
                    <h2>Produits en promotion</h2>
                    <small>Prix réduits sur une sélection de produits disponibles</small>
                </div>
                <a href="{{ $catalogUrl }}?offer=promotion">Voir tout <span>→</span></a>
            </div>
                ...
                @foreach($promoList as $product)
                    ...
                    <article class="ov-product-card">
                        ...
                        <div class="ov-product-card__body">
                            ...
                            @if($productDiscount)
                                <small class="ov-old-price">{{ $formatPrice((float) ($product->price ?? 0)) }}</small>
                            @endif
                            @if($productRating)
