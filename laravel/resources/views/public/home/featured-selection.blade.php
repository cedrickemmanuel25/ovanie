        ...
        <section class="ov-panel ov-featured-selection-panel">
            <div class="ov-section-head">
                <div class="ov-section-head__title">
                    <span class="ov-kicker">SÉLECTION OVANIE</span>
                    <h2>{{ $featureTitle }}</h2>
                    <small>{{ $featureDescription }}</small>
                </div>
                <a href="{{ $featureUrl }}">Voir tout <span>→</span></a>
            </div>
