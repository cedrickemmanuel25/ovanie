...
<div class="cat-header">
    ...
    <div class="cat-header-actions">
        <a href="{{ route('daniel.add_product', ['type' => 'single']) }}" class="cat-btn primary" id="btn-add-product">
                    ...
                    <tr data-product-id="{{ $product->id }}">
                        ...
                        <td>
                            <div class="cat-row-actions" style="justify-content:flex-end;">
                                <a href="{{ route('daniel.products.edit', $product->id) }}"
                    ...
                    <tr>
                        <td colspan="8">
                            <div class="cat-empty">
                                ...
                                <a href="{{ route('daniel.add_product') }}" class="cat-btn primary">
                                    <i data-lucide="plus"></i> Ajouter un produit
                                </a>
                            </div>
                        </td>
