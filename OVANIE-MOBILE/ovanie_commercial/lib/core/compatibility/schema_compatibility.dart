...
abstract final class OvanieSchemaContract {
  static const String appCode = 'commercial';
  static const String appLabel = 'OVANIE Commercial';
...
class OvanieSchemaIncompatibleApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        useMaterial3: true,
        colorScheme: ColorScheme.fromSeed(seedColor: const Color(0xff00102d)),
      ),
      home: Scaffold(
        body: SafeArea(
          child: Center(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      textAlign: TextAlign.center,
                      style: TextStyle(color: const Color(0xff3b9fff), fontWeight: FontWeight.w700),
                    ),
                  ],
                ),
              ),
