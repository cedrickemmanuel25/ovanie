...
abstract final class OvanieSchemaContract {
  static const String appCode = 'driver';
  static const String appLabel = 'OVANIE Livreur';
...
class OvanieSchemaIncompatibleApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        useMaterial3: true,
        colorScheme: ColorScheme.fromSeed(seedColor: const Color(0xff067a46)),
      ),
      home: Scaffold(
        body: SafeArea(
          child: Center(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      textAlign: TextAlign.center,
                      style: TextStyle(color: const Color(0xff067a46), fontWeight: FontWeight.w700),
                    ),
                  ],
                ),
              ),
